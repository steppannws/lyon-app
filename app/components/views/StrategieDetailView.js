...
export default class StrategieDetailView extends Component {
  ...
  componentDidMount() {
    ...
    Utils.log('STRATEGIE DETAILS PROPS:', this.props.data);
      ...
      return(<View style={{ flex: 0 }}>            
                <View style={{marginTop: 0, marginLeft:10, marginRight:10}}>
                    ...
                    <View style={{alignItems: 'center'}} >
                      ...
                      {/*<Text style={styles.percentReturn}>{this.state.data.finance.ytdReturn.fmt}</Text>*/}
                    ...
                    {/*<Text style={styles.summeryText}>{this.state.data.profile.summery}</Text>*/}
                </View>
                ...
                <Grid>
                  ...
                  <Col>
                    ...
                    <View style={{alignItems: 'center'}} >
                      ...
                      <Text style={styles.percent}>{this.state.data.finance.yield.fmt || "-"}</Text>
                    </View>
                  ...
                  <Col>
                    ...
                    <View style={{alignItems: 'center'}} >
                      ...
                      <Text style={styles.percent}>{this.state.data.finance.totalAssets.fmt || "-"}</Text>
                    </View>
                ...
                <View style={{paddingTop: 30, paddingBottom: 30}}>
                  ...
                  <View style={{marginLeft:10, marginRight:20}}>
                    ...
                    <View style={{marginTop: 20}} />
                    <List>
                        {this.state.data.topHoldings.map((item)=>{
                          return <StockCell 
                            key={item.symbol}
                            data={item}
    ...
    if(!this.state.loading) {
      return(<View style={styles.investButtonContainer}>
              <Button block style={styles.investButton}
                      onPress={() => Actions.investnow({data: {data:this.state.data, type: 'etf'}})} >
                Invest now
              </Button>
            </View>);
    }
