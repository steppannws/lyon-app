...
export default class InvestNowView extends Component {
  ...
  componentDidMount() {
    ...
    // console.warn('data', this.props.data.data.profile.name);
  ...
  sendForm() {
    ...
    Alert.alert(
      'Sent',
      'We send you an e-mail with more information.',
        [
          ...
          <View style={{flex:1}}>
              ...
              <List>
                  <ListItem>
                      <InputGroup >
                          {/*<Icon name="ios-mail" />
                          <Input placeholder="ID / Account Number" />*/}
                           <Input inlineLabel label="Account Number" placeholder="" />
                      </InputGroup>
                  </ListItem>
                  ...
                  <ListItem>
                        ...
                        {/*<Icon name="ios-lock" />*/}
                        <Text>{'Desea invertir en ' + this.props.data.data.profile.name}</Text>
